...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SmallRookie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '小菜鸟', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xzptop.sbs', // 网站地址
